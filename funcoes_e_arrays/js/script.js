...
// function soma(girafas, fogoes){
//     console.log(`A soma entre ${girafas} e ${fogoes} é = ${girafas + fogoes}`)
//     console.log(`A subtração entre ${girafas} e ${fogoes} é = ${girafas - fogoes}`)
//     console.log(`A divisão entre ${girafas} e ${fogoes} é = ${girafas / fogoes}`)
//     console.log(`A multiplicação entre ${girafas} e ${fogoes} é = ${girafas * fogoes}`)
// }
...
//     console.log(`Elemento da lista: ${cores[i]}`)
// }
